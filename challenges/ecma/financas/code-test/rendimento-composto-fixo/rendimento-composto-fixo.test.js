...
describe('RendimentoCompostoFixo', function () {
  ...
  test.skip('obtendo o rendimento de uma entrada de 100, com aportes de 500, juros de 0.5936 e prazo de 24 meses', function () {
    expect(redimentoCompostoFixo(100, 500, 0.5936, 24)).toEqual(12971.227695545636)
  })

  test.skip('obtendo o rendimento de uma entrada de 100, com aportes de 500, juros de 0.5936 e prazo de 36 meses', function () {
    expect(redimentoCompostoFixo(100, 500, 0.5936, 36)).toEqual(20125.781003832304)
  })

  test.skip('obtendo o rendimento de uma entrada de 100, com aportes de 500, juros de 0.5936 e prazo de 120 meses', function () {
