...
// Eventos para adquirir o IP
btnGetIp = document.querySelector("#btnGetIp")
...
inputIpAddress = document.querySelector("#inputIpAddress")
ipTable = document.querySelector("#ipTable")
        ...
        if (!flag) {
            ...
            fetch(url)
                ...
                .then(function (values) {
                    ...
                    let addJson = { ip: ip, city: city, country: country, org: org, close: `<i class="fa fa-times ${ipJson.length}" style="font-size: 22px;"></i>` }
                    ipJson.push(addJson)
                    render()
                })
        }
